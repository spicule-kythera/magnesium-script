...
abstract public class Expression {
    ...
    abstract public Expression parse(Map<String, Object> tokens) throws InvalidExpressionSyntax, Parser.InvalidExpressionType;
...
//    protected static boolean isMapType(Type keyType, Type valueType, Object map) {
//        if(!(map instanceof Map)) {
//            return false;
//        }
//
//        Object key = ((Map<?, ?>) map).keySet();
//
//        return true;
//    }
}